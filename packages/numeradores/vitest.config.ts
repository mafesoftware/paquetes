...
/**
 * Este paquete es el primero que depende de OTRO paquete del monorepo en
 * tiempo de ejecución (`@mafesoftware/tenant/drizzle`, workspace
 * dependency). Node resuelve ese specifier vía el `exports` de
 ...
 * pipeline — la app que instale `@mafesoftware/numeradores` de verdad sigue
 * importa el `dist` publicado de tenant, esto es solo para los tests
